...
class StateProcessor {
 public:
  ...
  void encode_policy_features(int32_t* memory_map, float* features_out, const bool* safe_moves);
  void encode_value_features(int32_t* memory_map, float* features_out);
